...
function harmonic_osci_damped!(du,u,p,t)
	c,k = p # die Einträge sind mit der Masse skaliert
	du[1] = u[2]
	du[2] = - c*u[2]-k*u[1]
end
...
# ╔═╡ 94aae70b-01bf-49ed-a7f8-f27e2f5aecbd
md"""
Anfangszeitpunkt:
"""

# ╔═╡ bde807a5-7980-456c-a358-70ead4939568
tbegin=0
...
problem = ODEProblem(harmonic_osci_damped!,u0,tspan,p)
...
function plot_harmonic_oscillator(t,u0,k)
	p = [0,k] # stelle sicher, dass es nur ein harmonischer Oszillator ist
	# keine Dämpfung; nur "Federkonstante"
	problem = ODEProblem(harmonic_osci_damped!,u0,tspan,p)
	sol = solve(problem)
	p1 = plot(sol,idxs=[1],
		xlabel="Zeit",
